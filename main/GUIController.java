    ...
    public void btnStart() throws InterruptedException, IOException {
        ...
        if (cb.getSelectionModel().getSelectedIndex() > -1) {
            switch (cb.getSelectionModel().getSelectedIndex() + 1) {
                case 1:
                    museumOperation("main/testcases/BestCaseScenario.txt");
                    break;
                case 2:
                    museumOperation("main/testcases/NormalCaseScenario.txt");
                    break;
                case 3:
                    museumOperation("main/testcases/WorstCaseScenario.txt");
                    break;
                case 4:
                    museumOperation("main/testcases/ExceedHourlyLimit.txt");
                    break;
                case 5:
                    museumOperation("main/testcases/ExceedTicketTimePurchase.txt");
                    break;
            }
            sb.setDisable(true);
            cb.setDisable(true);
