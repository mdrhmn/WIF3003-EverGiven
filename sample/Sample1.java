...
//                     people.release();
//                     System.out.println(Thread.currentThread().getName() + ":    Guest Entered at " + name +", Guests = " + guestCounter.guestCount);
...
//                 System.out.println(Thread.currentThread().getName() + ":    Guest left at " + name + ", Guests = " + guestCounter.guestCount);
